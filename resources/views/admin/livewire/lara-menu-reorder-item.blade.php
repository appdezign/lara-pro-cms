<div @class([
	'item',
	'lara-reorder-menu-item',
	'handle',
	'cursor-move',
	'no-drag' => $item->is_home,
])
     clazz="item lara-reorder-menu-item handle cursor-move"
     data-id="{{ $item->id }}" wire:key="{{'menu-item-'.$item->id}}">
	<div @class([
	...
	>
		@foreach($item->children as $children)
			@include('lara-admin::livewire.lara-menu-reorder-item', ['item' => $children])
		@endforeach
    </div>
</div>
